(() => {
    ...
    let formValidate = {
        ...
        formClean(form) {
            ...
            setTimeout((() => {
                ...
                if (modules_rflModules.select) {
                    let selects = form.querySelectorAll(".select");
                    if (selects.length) for (let index = 0; index < selects.length; index++) {
                        const select = selects[index].querySelector("select");
                        modules_rflModules.select.selectBuild(select);
                    }
                }
            }), 0);
        },
    ...
    function formSubmit() {
        ...
        function formSent(form, responseResult = ``) {
            ...
            setTimeout((() => {
                if (modules_rflModules.popup) {
                    const popup = form.dataset.popupMessage;
                    popup ? modules_rflModules.popup.open(popup) : null;
                }
            }), 0);
            formValidate.formClean(form);
    ...
    modules_rflModules.watcher = new ScrollWatcher({});
